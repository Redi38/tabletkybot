...
TEXTS = {
    "ua": {
        ...
        "btn_lang": "🌐 Мова",
        "btn_repeat_reminders_on": "🔁 Повторні нагадування: увімкнено",
        "btn_repeat_reminders_off": "🔁 Повторні нагадування: вимкнено",
        "btn_list": "📋 Список",
        "btn_medicines": "💊 Ліки",
        "btn_no": "❌ Ні",
    ...
    "ru": {
        ...
        "btn_help": "ℹ️ Помощь",
        "btn_lang": "🌐 Язык",
        "btn_repeat_reminders_on": "🔁 Повторные напоминания: включены",
        "btn_repeat_reminders_off": "🔁 Повторные напоминания: выключены",
        "btn_list": "📋 Список",
