...
TEXTS = {
    "ua": {
        ...
        "btn_lang": "🌐 Мова",
        "btn_repeat_reminders_on": "🔁 Повторні нагадування: увімк.",
        "btn_repeat_reminders_off": "🔁 Повторні нагадування: вимк.",
        "btn_list": "📋 Список",
        "btn_medicines": "💊 Ліки",
        "btn_no": "❌ Ні",
        ...
        "help_text": (
            ...
            '• Гнучке редагування: назва, дозування, час прийому, тривалість курсу, залишок і поріг "мало ліків"\n'
            "• Продовження курсу та видалення ліків\n\n"
            "<b>📝 Рецепти:</b>\n"
        ...
        "lang_already_selected": "ℹ️ Цю мову вже обрано.",
    ...
    "en": {
        ...
        "btn_help": "ℹ️ Help",
        "btn_lang": "🌐 Language",
        "btn_repeat_reminders_on": "🔁 Repeat reminders: on",
        "btn_repeat_reminders_off": "🔁 Repeat reminders: off",
        "btn_list": "📋 List",
        ...
        "help_text": (
            ...
            "• Flexible editing: name, dosage, intake time, course length, stock and low-stock threshold\n"
            "• Extend the course, or delete medicines\n\n"
            "<b>📝 Prescriptions:</b>\n"
        ...
        "lang_already_selected": "ℹ️ This language is already selected.",
    ...
    "ru": {
        ...
        "btn_help": "ℹ️ Помощь",
        "btn_lang": "🌐 Язык",
        "btn_repeat_reminders_on": "🔁 Повторные напоминания: вкл.",
        "btn_repeat_reminders_off": "🔁 Повторные напоминания: выкл.",
        "btn_list": "📋 Список",
        ...
        "help_text": (
            ...
            '• Гибкое редактирование: название, дозировка, время приёма, длительность курса, остаток и порог "мало лекарства"\n'
            "• Продление курса и удаление лекарств\n\n"
            "<b>📝 Рецепты:</b>\n"
        ...
        "lang_already_selected": "ℹ️ Этот язык уже выбран.",
