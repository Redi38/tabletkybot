"""
Tests for handlers/medicines/intake.py — process_medicine_status: the
take_/skip_ reminder-button handler.
"""
...
from handlers.medicines.intake import process_medicine_status
